...
URL = "http://43.154.191.136:7500/api/infer"
def get_voice(prompt:str):
    '''get voice'''
    data = {
    "prompt":prompt,
    "speaker":"可莉 Klee (Genshin Impact)",
    "lang":"简体中文",
    "speed":0.5
    }
    headers = {
    ...
    wav = httpx.get("http://43.154.191.136:7500"+json.loads(res.text)["url"]).content
    return wav
if __name__ == "__main__":
    with open("./voice.wav","wb") as f:
        f.write(get_voice("O神，启动！"))
''' 
